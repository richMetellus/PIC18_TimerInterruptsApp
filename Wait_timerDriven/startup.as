	...
	;This licence will expire on Thu, 19 Apr 2018
	...
	; Compiler options:
	;
	; -otimerwait.cof -mtimerwait.map --summary=default --output=default \
	; timer0.p1 --chip=18F4620 -P --runtime=default --opt=default \
